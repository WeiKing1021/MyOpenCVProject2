...
public class OpenCVProject2 {
	...
	public static void f(int n) {
		...
		try {
			...
			Mat hand_mat_1 = Util.image2cvMat(ImageIO.read(new File(ROOT, "./opencv/hand_" + n + ".jpg")));

			Mat hand_hsvmat_1 = hand_mat_1.clone();

			Imgproc.cvtColor(hand_mat_1, hand_hsvmat_1, Imgproc.COLOR_BGR2HSV);

			Util.showImage("Hand " + n, Util.cvMat2image(hand_mat_1));
...
//			Util.showImage("Result", Util.cvMat2image(result));
			...
			Util.showImage("Close " + n, close_after);
		} catch (Exception e) {
